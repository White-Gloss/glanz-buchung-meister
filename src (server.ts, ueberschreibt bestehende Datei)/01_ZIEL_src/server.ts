...
function withProductionHeaders(request: Request, response: Response): Response {
  ...
  // Content-Security-Policy: Fremdressourcen sind bewusst auf die minimal
  // nötige Liste beschränkt. Google Ads ist NUR enthalten, weil das
  // Conversion-Tracking (mit Cookie-Einwilligung, siehe CookieConsent.tsx)
  // eingerichtet ist – ohne dieses Feature bräuchte es diese Zeilen nicht.
  // 'unsafe-inline' ist für die JSON-LD-Blöcke, den Hydration-State und das
  // kleine Inline-Init-Skript des Google-Tags nötig.
  headers.set(
    ...
    [
      ...
      "connect-src 'self' https://*.supabase.co https://www.googletagmanager.com https://www.google.com https://www.google-analytics.com",
