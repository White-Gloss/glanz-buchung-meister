    ...
    <div className="mx-auto w-full max-w-xl rounded-2xl border border-border bg-secondary/20 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-7 gap-1" role="group" aria-label="Verfügbare Wunschtermine">
        {cells.map((date, index) => {
          ...
          const disabled = date < today || !isOnlineBookingDay(date) || full;
          ...
          {step === 4 && (
            <section>
              <StepHeader
                ...
                text="Online wählen Sie Ihren Wunschtermin von Montag bis Freitag. Samstagstermine stimmen wir ausschließlich persönlich per WhatsApp ab. White Gloss prüft die Anfrage anschließend und bestätigt den finalen Termin als Admin."
              />
