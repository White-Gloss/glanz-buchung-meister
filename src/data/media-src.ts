...
export const heroAvifSrcSet =
  "/media/hero-gloss-720.avif 720w, /media/hero-gloss-1080.avif 1080w, /media/hero-gloss-1600.avif 1600w";
export const heroWebpSrcSet =
  "/media/hero-gloss-720.webp 720w, /media/hero-gloss-1080.webp 1080w, /media/hero-gloss-1600.webp 1600w";
export const heroPreloadMobile = "/media/hero-gloss-720.avif";
export const heroPreloadHref = "/media/hero-gloss-1080.avif";
export const heroPreloadWide = "/media/hero-gloss-1600.avif";
